...
export function RevisionComparison({ oldSubmission, newSubmission, rejectionRemarks }: Props) {
  return (
    <div className="bg-slate-900 rounded-[3rem] p-10 text-white space-y-8 shadow-2xl overflow-hidden relative">
      ...
      <div className="flex items-center gap-4 border-b border-white/10 pb-6">
        ...
        <div>
          <h3 className="text-sm font-black uppercase tracking-widest">Forensic Delta Analysis</h3>
      ...
      <div className="grid md:grid-cols-2 gap-8 relative z-10">
        ...
        <div className="space-y-4 opacity-60 grayscale hover:grayscale-0 transition-all">
          ...
          <div className="bg-white/5 border border-white/10 p-6 rounded-3xl">
             ...
             <p className="text-xs font-bold truncate">{oldSubmission?.file_url.split('/').pop()}</p>
             <div className="mt-4 p-4 bg-rose-500/10 rounded-xl border border-rose-500/20">
                ...
                <p className="text-[10px] italic text-rose-100 italic leading-relaxed">"{rejectionRemarks}"</p>
             </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white/10 border-2 border-emerald-500/30 p-6 rounded-3xl shadow-xl shadow-emerald-500/5">
             ...
             <p className="text-xs font-black truncate">{newSubmission?.file_url.split('/').pop()}</p>
             <a 
        ...
        {/* Connector Arrow */}
        <div className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-slate-800 border border-white/10 rounded-full items-center justify-center">
